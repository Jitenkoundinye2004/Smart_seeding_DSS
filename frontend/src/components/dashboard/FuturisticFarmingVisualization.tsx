      ...
      {prediction && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <Card className="shadow-strong border-primary/20 bg-gradient-card">
            ...
            <CardContent>
              <div className="mb-6">
                <h4 className="text-sm font-semibold mb-2">{t('sowingRecommendation')}</h4>
                <p className={`text-xl font-bold ${prediction.sowing_recommendation === 'Yes' ? 'text-green-600' : 'text-red-600'}`}>
