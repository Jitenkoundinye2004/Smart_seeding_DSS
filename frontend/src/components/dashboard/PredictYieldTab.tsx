        ...
        <div className="space-y-6">
            <Card className="shadow-medium border-secondary/20">
                ...
                <CardContent>
                    {/* Error Message */}
                    {fetchError && (
                        <div className="bg-red-50 border border-red-200 text-red-600 p-4 rounded-lg mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-center sm:text-left">
                            <span className="text-sm font-medium">{fetchError}</span>
                            <Button
                                variant="outline"
                                size="sm"
                                onClick={fetchDropdowns}
                                className="border-red-200 hover:bg-red-50 text-red-600 w-full sm:w-auto mt-2 sm:mt-0"
                            >
